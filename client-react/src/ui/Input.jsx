...
var InputWrapper = styled_components_1.default.input(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  border-radius: 2px;\n  padding: 7px;\n  width: 200px;\n  padding-left: 15px;\n  font-size: 16px;\n  margin-bottom: 10px;\n  height: 25px;\n  border: 0;\n  transition: border-color 1000ms;\n  font-family: 'Museo-Sans';\n  background-color: ", ";\n  box-shadow: 1px 2px 3px 0 ", ";\n  &:focus {\n    outline: 0;\n    box-shadow: 1px 2px 3px 1px ", ";\n  }\n  ", ";\n"], ["\n  border-radius: 2px;\n  padding: 7px;\n  width: 200px;\n  padding-left: 15px;\n  font-size: 16px;\n  margin-bottom: 10px;\n  height: 25px;\n  border: 0;\n  transition: border-color 1000ms;\n  font-family: 'Museo-Sans';\n  background-color: ", ";\n  box-shadow: 1px 2px 3px 0 ", ";\n  &:focus {\n    outline: 0;\n    box-shadow: 1px 2px 3px 1px ", ";\n  }\n  ",
...
exports.Input = function (props) { return (<>
    <InputWrapper {...props}/>
    <Error_1.Error visible={!!props.error && props.shouldShowError}>
      {props.error}
    </Error_1.Error>
  </>); };
exports.useInput = function (_a) {
